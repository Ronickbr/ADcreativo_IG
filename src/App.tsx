  ...
  return (
    <div>
      ...
      <div className="upload-zone group">
        ...
        >
          {value.preview ? (
            <img src={value.preview} alt={`Pré-visualização de ${label}`} className="h-full w-full object-contain p-3" />
          ) : (
        ...
        {value.preview && (
          <button
            ...
            className="absolute right-2 top-2 rounded-full bg-black/70 p-1.5 text-white transition hover:bg-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime-400"
          >
            <X size={14} />
          </button>
        )}
